...
var ChatApp = function ChatApp() {
  ...
  _wsClient2.default.registerOpenHandler(function () {
    _this.chatForm.init(function (data) {
      ...
      _wsClient2.default.sendMessage(message.toObj());
    });
  });
  ...
  _createClass(ChatForm, [{
    ...
    value: function init(submitCallback) {
      ...
      $(this.formId).submit(function (event) {
        ...
        var val = $(_this.inputId).val();
        submitCallback(val);
        $(_this.inputId).val('');
      });
      $(this.formId).find('button').on('click', function () {
        $(_this.formId).submit();
      });
    }
  }]);
  ...
  _createClass(ChatList, [{
    ...
    value: function init() {
      this.timer = setInterval(function () {
        $('[data-time]').each(function (idx, element) {
          var $element = $(element);
